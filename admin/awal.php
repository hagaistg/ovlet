...
<html lang="en">
	<head>
		...
		<meta charset="utf-8" />
		<title>Dashboard - Admin OVLET</title>
	...
	<body class="no-skin">
		<div style="background-color: #222" id="navbar" class="navbar navbar-default          ace-save-state">
			<div class="navbar-container ace-save-state" id="navbar-container">
				...
				<div class="navbar-header pull-left">
					<a href="awal.php" class="navbar-brand">
						<small style="color:#FFFF4B">
							<h4><b><i> </i></b></h4>
							<a class="navbar-brand" href=""><img class="logo" src="../images/logokita.png" alt="" width="200px" height="30px"></a>
		...
		<div class="main-container ace-save-state" id="main-container">
			...
			<div id="sidebar" class="sidebar responsive ace-save-state">
				...
				<ul class="nav nav-list">
					<li class="">
							<i class=""></i>
							<span class="menu-text"><h3><b> &nbsp;&nbsp; ADMIN Rental</b></h3></span>
				...
				<div class="footer-inner">
					<div class="footer-content">
						<span class="bigger-120">
							<span class="blue bolder" style="color:#FFFF4B">Online Vehicle Toba</span>
							&copy; 2017-2018
						</span>
